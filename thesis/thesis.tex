...
\newcommand\pcode[2]{
	\lstinputlisting[language=python, caption={#1},label=lst:#2]{src/#2}
}

\newcommand\jscode[2]{
	\lstinputlisting[language=js, caption={#1},label=lst:#2]{src/#2}
}

\newcommand\bcode[2]{
	\lstinputlisting[language=bash, caption={#1},label=lst:#2]{src/#2}
}
